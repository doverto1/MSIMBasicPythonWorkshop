...
# You code here
print ("Person 1: " +firstNames[0]+ " " +lastNames[0][0]+ " is " +str(ages[0])+ " years old")
print ("Person 2: " +firstNames[1]+ " " +lastNames[1][0]+ " is " +str(ages[1])+ " years old")
print ("Person 3: " +firstNames[2]+ " " +lastNames[2][0]+ " is " +str(ages[2])+ " years old")
print ("Person 4: " +firstNames[3]+ " " +lastNames[3][0]+ " is " +str(ages[3])+ " years old")
print ("Person 5: " +firstNames[4]+ " " +lastNames[4][0]+ " is " +str(ages[4])+ " years old")